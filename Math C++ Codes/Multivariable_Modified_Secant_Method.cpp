...
This program calculates the roots of a 2-equation system using Multivariable Modified Secant Method
...
{
    ofstream fout;
    fout.open("Multivariable Modified Secant Method");
    ...
    xi[1]=10.0;
    pf=pow(10,-10);            //sets perturbation factor
    ...
    //if inital guesses are right for x1 and x2, the problem is solved
